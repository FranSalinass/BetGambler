...
CREATE PROCEDURE AltaUsuario(unaContra CHAR(20), unNombre VARCHAR(20), unMail VARCHAR(30), dinero DOUBLE, unaEdad SMALLINT UNSIGNED, unNacimiento DATE)
BEGIN
    INSERT INTO Usuario (contra, nombre, mail, saldo, fecha_registro, edad, nacimiento)
    VALUES (unaContra, unNombre, unMail, dinero, NOW(), unaEdad, unNacimiento) ;
END $$
