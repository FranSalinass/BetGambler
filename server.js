...
app.post('/Registrar', (req, res) => {
  ...
  connection.query(checkUserQuery, (error, results) => {
    ...
    CALL AltaUsuario('${userData.contrasena}', '${userData.nombre}','${userData.apodo}', '${userData.dni}', '${userData.email}', ${userData.edad}, '${userData.fecha_nacimiento}')`;
    ...
    connection.query(insertUserQuery, (error) => {
      ...
      return res.status(201).send('Usuario registrado exitosamente.'), res.redirect('/index.html');
    });
  });
});
